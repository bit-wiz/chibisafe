<template>
	<div class="h-screen w-full overflow-auto">
		<div class="flex flex-col items-center w-full self-center text-light-100" v-if="notAdmin">
			<Header />
		</div>
		<div class="flex flex-col items-center h-auto min-h-[900px] w-full text-light-100 justify-center self-center">
				...
				>
					<div v-if="notAdmin">
						...
						<p class="mt-10 text-lg pr-16 mobile:pr-0">
							<strong>chibisafe</strong> is a modern and self-hosted take on file uploading services that
							can handle anything you throw at it thanks to it's robust and fast API, chunked uploads
							support and more.
						</p>
			...
			<div class="flex w-full mt-32 mobile:mt-20 flex-col max-w-4xl mobile:p-6" v-if="notAdmin">
			...
			<div class="flex w-full mt-32 mobile:mt-20 flex-col max-w-4xl mb-32 mobile:p-6" v-if="notAdmin">
...
const notAdmin = new URLSearchParams(window.location.search).get('upname') === null;
